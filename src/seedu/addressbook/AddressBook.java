...
public class AddressBook {
    ...
    private static final String COMMAND_SORT_DESC = "Displays all persons as a list with index numbers sorted alphabetically.";
    ...
    private static String executeListSortedAllPersonsInAddressBook() {
        ArrayList<HashMap<PersonProperty, String>> toBeDisplayed = getSortedAllPersons();
        showToUser(toBeDisplayed);
        return getMessageForPersonsDisplayedSummary(toBeDisplayed);
    }
    ...
    */
    ...
    /**
     * Reorders persons in ALL_PERSONS in alphabetical order.
     */
    private static ArrayList<HashMap<PersonProperty, String>> getSortedAllPersons() {
        ArrayList<HashMap<PersonProperty, String>> temp = new ArrayList<>();
        temp.addAll(ALL_PERSONS);

        Collections.sort(temp, new Comparator<HashMap<PersonProperty, String>>() {
            @Override
            public int compare(HashMap<PersonProperty, String> p1, HashMap<PersonProperty, String> p2) {
                return p1.get(PersonProperty.NAME).compareToIgnoreCase(p2.get(PersonProperty.NAME));
            }
        });
        return temp;
    }
     ...
     */
    private static String removePrefix(String fullString, String prefix) { return fullString.replace(prefix, ""); }
